...
import { background, common, grey, text } from "./palette";
import { typography } from "./typography";

const MuiBackdrop: Components<Theme>["MuiBackdrop"] = {
  styleOverrides: {
    root: ({ theme }) => ({
      backgroundColor: varAlpha(grey["900Channel"], 0.8),
    }),
    invisible: {
...
const MuiOutlinedInput: Components<Theme>["MuiOutlinedInput"] = {
  styleOverrides: {
    notchedOutline: ({ theme }) => ({
      borderColor: varAlpha(grey["500Channel"], 0.2),
    }),
  },
};
...
const MuiPaper: Components<Theme>["MuiPaper"] = {
  ...
  styleOverrides: {
    ...
    outlined: ({ theme }) => ({
      borderColor: varAlpha(grey["500Channel"], 0.16),
    }),
  },
};
...
const MuiTableCell: Components<Theme>["MuiTableCell"] = {
  styleOverrides: {
    head: ({ theme }) => ({
      ...
      backgroundColor: background.light.neutral,
    }),
  },
};
