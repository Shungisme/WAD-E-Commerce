...
class SendMailHelper {
	...
	sendResetPassword = async (to, newRandomPassword) => {
		const mailOptions = {
			from: process.env.EMAIL_USER,
			to: to,
			subject: 'Your New Random Password',
			html: `
				<!DOCTYPE html>
				<html lang="en">
					<head>
					...
					<body>
						<div class="container">
							...
							<div class="body">
								<p>Your password has been successfully changed. Below is your new randomly generated password:</p>
								<p><strong>Your New Password: <span class="highlight">${newRandomPassword}</span></strong></p>
								<p>Please use the above password to log in and change it after signing in for security reasons.</p>
								<a href="http://localhost:3000/login" class="cta-button">Go to Login</a>
							</div>
							<div class="footer">
